...
LEXICON_RU = {
    ...
    'help_command_text': (
        ...
        "● `/bonus` \- Получить периодический контейнер с припасами \(`!контейнер`\)\.\n"
        ...
        "● **Контейнер снабжения \(`!контейнер`\):** Каждые 2 часа запрашивайте сброс припасов, используя команду в личном чате или группе\. Внутри находится случайная награда\.\n\n"
        "**\-\-\- АРМИЯ И БОИ \-\-\-**\n"
    ...
    # --- Ежедневный бонус ---
    'bonus_menu_title': '🎁 **Периодический контейнер**\n\nНа вашу базу сброшен контейнер с припасами. Готов к вскрытию!',
    'bonus_button_text': '🛄 Вскрыть контейнер',
    'bonus_cooldown': 'Следующий контейнер с припасами будет сброшен через: **{time_left}**',
    'bonus_opening': 'Взламываем замок контейнера... {spinner}',
    'bonus_success': '✅ Контейнер вскрыт!\n\nВаша награда: {prize_text}',
    'bonus_notification': '🎁 Командир, на вашу базу сброшен новый контейнер с припасами! Используйте команду `!контейнер`, чтобы забрать его.',
    'group_bonus_claim_reply': '{user_mention}, ваш персональный контейнер доставлен в личные сообщения! 📦',
    ...
    'building_info_warehouse': '\n\nВместимость: `{capacity}` 💰\nПод защитой от грабежа: `{protected}` 💰',
    'building_info_command_center': '\n\nТекущее производство: `+{production}` 💰/час',
    'building_info_barracks': '\n\nВремя подготовки бойца: `{training_time}` сек',
